...
?>
<li class="border border-[#e8e8e8] py-4 px-6 wc_payment_method payment_method_<?php echo esc_attr($gateway->id); ?>">
    <div class="flex items-center gap-2">
        <input id="payment_method_<?php echo esc_attr($gateway->id); ?>" type="radio"
            class="input-radio radio radio-primary" name="payment_method" value="<?php echo esc_attr($gateway->id); ?>"
