...
if (apply_filters('woocommerce_checkout_show_terms', true) && function_exists('wc_terms_and_conditions_checkbox_enabled')) {
    ...
    ?>
    <div class="woocommerce-terms-and-conditions-wrapper py-6">
        <?php if (wc_terms_and_conditions_checkbox_enabled()): ?>
            <label class="woocommerce-form__label woocommerce-form__label-for-checkbox flex flex-row items-center gap-3">
