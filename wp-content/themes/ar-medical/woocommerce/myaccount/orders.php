                    ...
                    <?php foreach (wc_get_account_orders_columns() as $column_id => $column_name):
                        ...
                        <?php if ($is_order_number): ?>
                            ...
                            <?php elseif ($is_order_number): ?>
                                ...
                                <a class="font-medium underline hover:text-primary"
                            ...
                            <?php elseif ('order-actions' === $column_id): ?>
                                ...
                                if (!empty($actions)) {
                                    foreach ($actions as $key => $action) { // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
                                        ...
                                        echo '<a href="' . esc_url($action['url']) . '" class="underline hover:text-primary" aria-label="' . esc_attr(sprintf(__('View order number %s', 'woocommerce'), $order->get_order_number())) . '">' . esc_html($action['name']) . '</a>';
                                    }
                                }
                                ?>
                            <?php endif; ?>
